...
| project_name | string/mixed | As per request |
| funding_agency | string/mixed | As per request |
| date_of_sanction | string/mixed | As per request |
| funding_amount | string/mixed | As per request |
| role | string/mixed | As per request |
| project_status | string/mixed | As per request |
