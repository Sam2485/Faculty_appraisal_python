# Get Research Projects Summary

**URL Path:** `/api/v1/research-projects/summary/{faculty_id}`

**Method:** `GET`

**Description:** Retrieves the total research score for Research Projects for a specific faculty member.
...
## Response Data
- **Success (200 OK):**
    - `total_score` (float): Sum of points from all sanctioned research projects.
